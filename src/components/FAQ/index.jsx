        ...
        <Container>
          <CustomSegment size="large">
            ...
            <p>
              ...
              oficial de las elecciones del Tribunal Supremo Electoral (TSE) de
              El Salvador, entonces lo que se busca es hacer que muchas personas
              validen e ingresen a un sistema independiente los valores escritos
              en las actas, esto para luego poder hacer la sumatoria de votos
              por localidad y candidato y compararlo con los datos presentados
              de forma oficial por el TSE.
              <br />
              Para evitar favoritismos, el sistema recorta el número
              correspondiente a la cantidad de votos de un candidato en especial
              para una papeleta en especial, luego muestra el valor de la
              cantidad de votos al usuario para que los ingrese sin mostrar a
              qué candidato o partido pertenecen, de esta forma se evita que al
              ingresar la cantidad de votos se quiera favorecer a alguien. El
              sistema registra todas las entradas y agrupa por casillas y el
              valor que más se repita se toma como el válido y se agrega a la
              sumatoria total para ese candidato/a.
              <br />
              Respuesta Corta: El sistema busca validar de forma anónima la
              sumatoria de los resultados en las actas presentadas por las JRV.
              Para eso hace uso de técnicas digitales de extracción de los
              totales en las papeletas y con ayuda de las personas que usan el
              sistema, se puede hacer la digitación manual de datos para que el
            ...
            <p>
              ...
              personas validarán el mismo número y la mayoría enviarán el dato
            ...
            <p>
              ...
              Python, Ruby, OpenCV, Numpy, GIT, CakePHP, Javascript, Bootstrap y
              JQuery. El desarrollo del sistema y otras labores de apoyo está
              proporcionándose por personas que están donando su tiempo y
            ...
            <p>
              ...
              delegar a un sistema computarizado la tarea de leer los datos
              manuscritos e interpretarlos como válidos, así que se ha creado
              una forma de validación manual comunitaria anónima para que
            ...
            <p>
              ...
              conocimientos tecnicos adecuados, puedes bajar los datos CRUDOS de
